...
class ProjectRepository:
    def __init__(self):
        ...
        self.cosmos_uri = os.getenv(
            "COSMOS_URI", "https://mseonepoc-cosmos.documents.azure.com:443/"
        )
    ...
    def ensure_container_exists(self):
        ...
        try:
            ...
            container = self.database.create_container(
                id=self.container_name, partition_key=PartitionKey(path="/id"), offer_throughput=400
            )
    ...
    def update_project(
        ...
        try:
            ...
            updated_item = self.container.replace_item(
                item=project_id, body=existing_project.to_dict()
            )
    ...
    def get_budget_summary(self) -> dict:
        ...
        try:
            ...
            return {"total_budget": 0, "average_budget": 0, "max_budget": 0, "min_budget": 0}
        except Exception as e:
